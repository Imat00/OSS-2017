package prak4serv.com.denis.benutzer;
import prak4serv.com.denis.benutzer.*;
import java.util.*;
...
public class BenutzerVerwaltungAdmin implements BenutzerVerwaltung {
	 ...
	 */
	private final String dbname = "server/Benutzer.DB";
	...
	public boolean benutzerOk(Benutzer benutzer) {
		...
		if(benutzerTabelle.containsKey(benutzer.userId)) {
			if(benutzerTabelle.get(benutzer.userId).equals(benutzer)) {
				return true;
			}
		}
		return false;
